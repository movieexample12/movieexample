...
import com.listmovie.movies.MovieAndroid ;
import com.listmovie.movies.MoviesList ;
...
public class MovieAndroidService {
    ...
    public static Movie getInfo(int ID) throws IOException, JSONException {
        ...
        if (GeneralSettings.getApiKey() != null
            ...
            try {
                ...
                String jsonString = HttpManager.getResponseString (
                            BASE_URL
                            + MOVIE_GETINFO_URL
