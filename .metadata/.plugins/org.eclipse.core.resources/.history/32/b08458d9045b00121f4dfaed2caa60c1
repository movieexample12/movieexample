...
import com.listmovie.cinema.ticket.ChairContainer;
...
public class CinemaTabsBar extends Activity {
    ...
    private class DrawableView extends View {
    	...
    	private final int BORDERY = 9;
        
        private Paint mPaint;
        private ChairContainer canvasContainer;
            ...
            this.setOnTouchListener(new View.OnTouchListener(){
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    if (event.getAction() == MotionEvent.ACTION_DOWN) {
    					...
    					initialValues.put(Cinema.COLUMN_NAME_SEATSSIZE, canvasContainer.getFreeChairsCount());
    					initialValues.put(Cinema.COLUMN_NAME_SEATS, canvasContainer.getFreeChairs().toString());
    					
						CinemaTabsBar.this.getContentResolver().update(CinemaProvider.CONTENT_ID_URI_BASE, initialValues,  
								Cinema.COLUMN_NAME_ID_S + "=?", new String[] {getIntent().getStringExtra(Cinema.COLUMN_NAME_ID_S)});
		...
		protected void onDraw(Canvas canvas) {
            ...
            int W = getWidth() -  BORDERX;
            int H = getHeight() - BORDERY;
